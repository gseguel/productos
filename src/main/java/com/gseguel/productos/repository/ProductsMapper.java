...
public interface ProductsMapper {
    ...
    @Insert("INSERT INTO products (sku, name_products, brand, size_products, price, principal_image, other_images) "
    ...
    @Results(value = { 
            ...
            @Result(column = "name_products", property = "name"),
            @Result(column = "brand", property = "brand"), 
            @Result(column = "size_products", property = "size"),
    ...
    @Update("UPDATE products SET name_products = #{product.name}, brand = #{product.brand}, "
            + "size_products = #{product.size}, price = #{product.price}, "
